...
tempname memhold
postfile `memhold' total_cycles cycle round prop100 prop75 prop50 prop25 prop1 prop0 using `"${figures_source_data}/figure_ed1_source_data_distribution_`outcome'.dta"', replace
...
// sort
use `"${figures_source_data}/figure_ed1_source_data_distribution_`outcome'.dta"', clear
sort total_cycles cycle round
save `"${figures_source_data}/figure_ed1_source_data_distribution_`outcome'.dta"', replace
