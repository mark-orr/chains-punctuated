...
local i=1
areg `outcome`q'' schdnr loancycle i.officerid lnamtmemm i.nrterms i.schddateyear i.seasondummy, absorb(groupid) vce(cluster groupid)
...
local i=2
areg `outcome`q'' schdnr loancycle i.officerid lnamtmemm i.nrterms i.schddateyear i.seasondummy if total_cycles==5, absorb(groupid) vce(cluster groupid)
local coefficients`i' "1 2"
matrix m`i' = r(table)
scalar n`i' = e(N)
scalar ng`i' = e(k_absorb)  // number of groups
